...
/**
 * Servlet implementation class ShowAllFlower
 */
public class ShowAllFlower extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			String sql ="select *from flowertable";
 ...
 request.setAttribute("allflower", list);		
